document.addEventListener('DOMContentLoaded', () => BRM.initPrivatePage(async () => {
  ...
  main.innerHTML = `
    <div class="page-head">
      ...
      <div class="page-actions"><a class="button button-secondary" href="production-library.html">Script & sheet music</a><a class="button button-primary" href="downloads/BedfordRoadMusical-2.13.1.apk" download>Open in ScoreFlow</a></div>
    </div>
