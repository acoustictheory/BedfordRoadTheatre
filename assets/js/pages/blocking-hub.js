...
function isDoubleCastRole(c){const clean=value=>String(value||'').toLowerCase().replace(/[^a-z0-9]+/g,'');return ['mal','evie'].includes(clean(c?.CharacterKey))||['mal','evie'].includes(clean(c?.CharacterName))}
